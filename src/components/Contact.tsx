            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <Textarea 
                  ...
                  required
                  className="resize-none bg-gray-50 border-gray-200 min-h-[150px]"
                />
              </div>
              <Button 
                type="submit" 
          ...
          <div className="space-y-8">
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <div className="space-y-6">
                <ContactInfo 
                  icon={<Mail size={20} />}
                  title="Email"
                  content={<a href="mailto:mahak.jiwnani@example.com" className="text-portfolio-purple hover:underline">mahak.jiwnani@example.com</a>}
                />
                <ContactInfo 
                  icon={<Phone size={20} />}
                  title="Phone"
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <div className="flex space-x-4">
                <a href="#" className="p-3 bg-gray-100 rounded-full text-gray-600 hover:bg-portfolio-purple hover:text-white transition-colors">
